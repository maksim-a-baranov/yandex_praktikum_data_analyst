...
| [SQL запросы к БД книжного магазина](13_bootcamp_sql/) | Подключение к удаленной базе данных SQL. Подготовка SQL запросов из нескольких таблиц БД и выгрузка данных. Формулировние предложения для нового продукта. | pandas, sqlalchemy |
